...
function LimitedFormatPoints({ format, totalPoints, maximumPointsLimited }) {
  ...
  const textColor = totalPoints > maximumPointsLimited ? 'text-red-600' : 'text-green-600';
      ...
      <div className="max-w-3xl mx-auto p-6 bg-white shadow-md rounded-lg mt-10">
        ...
        <div className="mb-4">
          <form id="beybladeForm" className="space-y-6">
            <div>
              <label htmlFor="beybladeCount" className="block text-sm font-medium text-gray-700">
                Number of Beyblades
              </label>
              <input
                type="number"
                ...
                max="10"
                value={beybladeCount}
                onChange={(e) => setBeybladeCount(Number(e.target.value))}
        ...
        <div className="mt-6 text-center flex justify-center gap-2">
          ...
          <button
            ...
            className="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded-lg inline-flex items-center relative"
          >
            <svg
            ...
            <span>
              Download<small style={{ fontSize: '8px', display: 'block' }}>[experimental]</small>
            </span>
          </button>
        </div>
          ...
          >
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-500">
                I'm only doing this during my free time. I appreciate any amount! Thank you for your support! 🙏
              </p>
            </div>
          </div>
        </div>
